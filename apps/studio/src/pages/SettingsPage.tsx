  ...
  return (
    <section className="page">
      ...
      <WindowSharedStateBoard
        ...
        summary="Settings now exposes the same phase60 window roster, shared-state lane, orchestration board, review posture ownership map, reviewer queue, acknowledgement state, escalation/closeout windows, sync health, delivery-stage mapping, and local-only blockers that drive the main shell coordination board."
      />
