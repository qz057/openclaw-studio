      ...
      <div className="content-grid">
        <article className="surface card">
          <div className="card-header">
            <div>
              <h2>Roster</h2>
              <p>Configured agent and runtime lanes derived from local session and runtime data when available.</p>
            </div>
        ...
        <article className="surface card">
          <div className="card-header">
            <div>
              ...
              <p>Recent roster activity assembled from the same local observations backing the live lanes.</p>
            </div>
          </div>
