...
export function App() {
  ...
  const releasePipelineDepth = [
    ...
    },
    {
      ...
      detail:
        "Phase60 slice 15 turns replay scenario packs into a product review console with acceptance pass progression, screenshot pass records, capture review flow, and a proof-linked evidence bundle on top of the screenshot-driven acceptance review pack, acceptance scoreboard, route replay board, replay acceptance checklist, and direct restore / replay controls; it still does not install, publish, sign, orchestrate live approvals, advance staged decision lifecycles, settle publication receipts, roll back publish state, or enable host-side execution."
    }
  ];
          ...
          <section className="foundation-strip">
            ...
            <article className="surface card foundation-card">
              <div className="card-header card-header--stack">
                ...
                <p>
                  The alpha shell still does not build a real installer, but phase60 slice 15 now keeps the review-only delivery chain anchored in a
                  ...
                  screenshot pass records, capture review flow, a proof-linked evidence bundle, and product-review console polish, so review-surface
                  navigation, remembered handoff restore, active sequence replay, multi-window coverage, operator board ownership, reviewer queues,
