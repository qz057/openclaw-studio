...
async function verifyRendererFocusedSlotUi() {
  ...
  const requiredMarkers = [
    ...
    "Last focused slot",
    "Review Surface Resume",
    "Active review surface",
    "Restore Latest Handoff",
    "Inspect Cross-window Observability",
    "Final Review Closeout",
    "Final Verdict Console",
    "Final Review Settlement",
    "Acceptance Closeout Timeline",
    "Verdict progression",
    "Reviewer decision context",
    "Settlement route anchor",
    "Evidence chain",
    "Linked review surfaces",
    "Pack settlement lane",
    "Acceptance closeout console",
    "Next signoff handoff",
    "Signoff Readiness Queue",
    "Pack Closeout Board",
    "Load next verdict blocker",
    "Load timeline blocker",
    "Pack closure focus",
    "Pack settlement posture",
    "Current queue focus",
    "Next pack handoff",
    "Load next signoff",
    ...
    "Artifact checkpoint progression",
    "Current vs next handoff",
    "Current surface spine",
    "Next surface spine",
    ...
    "Artifact continuity",
    "Materialization Artifact Checkpoint Progression",
    "Inspector Materialization Checkpoint Progression",
    "Source artifacts",
    "Target artifacts",
    "Local review packet",
    ...
    "Review-step stage",
    "Next review step",
    "Packet rollback anchor",
    "Review-step manifest",
    "Step transition",
    "seal manifests",
    "integrity manifest",
