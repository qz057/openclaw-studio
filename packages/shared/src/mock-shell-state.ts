...
export const mockShellState: StudioShellState = {
  ...
  agents: {
    summary: "当前显示 Studio 本地编排视图：代理分工、隔离姿态、交接状态与运行态接入边界集中在这一页。",
    metrics: [
      {
    ...
    roster: [
      ...
      },
      {
        ...
        status: "complete",
        focus: "Runtime fallback path is stable and buildable.",
        approvals: "Closed",
  ...
  codex: {
    summary: "Codex 页面以本地只读观测为边界，当前回退数据用于保持任务、回合、恢复和上下文结构稳定。",
    stats: [
      { label: "Task Source", value: "Fallback", tone: "warning" },
    ...
    tasks: [
      {
        ...
        source: "mock",
        workdir: "apps/studio",
        detail: "Fallback task lane keeps the page stable until local Codex session data is available.",
      ...
      },
      {
        ...
        detail: "Review lane models future live approvals and trace metadata without mutating runtime state.",
      ...
      },
      {
        ...
        detail: "Fallback queue item shows behavior when no live Codex signals are readable.",
        loopState: "stable",
        turnCount: 1,
    ...
    observations: [
      ...
      },
      {
        ...
        label: "Auth",
        value: "Pending",
        detail: "Auth readiness will switch from fallback to observed when local Codex auth is readable.",
        tone: "neutral"
      },
      {
        ...
        detail: "Config and sessions roots stay fallback-backed until the runtime probe can read them safely.",
        tone: "neutral"
      }
    ],
    loopSummary:
