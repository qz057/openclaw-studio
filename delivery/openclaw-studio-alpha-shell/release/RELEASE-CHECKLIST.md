...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-apply-audit-packs-promotion-execution-checkpoints-rollback-operator-drillbooks-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
