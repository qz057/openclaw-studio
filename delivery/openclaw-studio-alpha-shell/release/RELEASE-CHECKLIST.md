# OpenClaw Studio Phase52 Release Checklist
...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-operator-approval-execution-envelopes-promotion-staged-apply-release-decision-records-rollback-cutover-publication-recovery-receipts-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
