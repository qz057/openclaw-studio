# OpenClaw Studio Phase50 Release Checklist
...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-operator-reconciliation-ledgers-promotion-staged-apply-closeout-journals-rollback-cutover-outcome-reports-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
