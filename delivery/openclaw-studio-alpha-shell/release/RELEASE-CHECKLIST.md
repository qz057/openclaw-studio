# OpenClaw Studio Phase53 Release Checklist
...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-operator-approval-routing-contracts-promotion-staged-apply-release-decision-enforcement-contracts-rollback-cutover-publication-receipt-closeout-contracts-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
