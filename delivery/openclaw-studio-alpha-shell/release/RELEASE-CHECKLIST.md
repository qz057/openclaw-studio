# OpenClaw Studio Phase51 Release Checklist
...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-operator-settlement-packs-promotion-staged-apply-signoff-sheets-rollback-cutover-publication-bundles-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
