# OpenClaw Studio Phase46 Release Checklist
...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-operator-worklists-promotion-staged-apply-ledgers-rollback-cutover-readiness-maps-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
