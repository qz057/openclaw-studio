...
- `release/REVIEW-MANIFEST.json` 必须列出 attestation-apply-execution-packets-promotion-operator-handoff-rails-rollback-live-readiness-contracts-skeleton pipeline stage、review docs、artifact groups、blocked 发布动作
