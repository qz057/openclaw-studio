...
- companion route-history memory now feeds a route replay board plus replay acceptance checklist, so returning to publish-gate, approval-queue, rollback-shadow, or handoff relay coverage can restore the last route, sequence, review surface, and multi-window posture locally
