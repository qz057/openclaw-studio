# OpenClaw Studio Phase56 Package Snapshot
...
- Renderer bundle: 3 files, 423.8 KiB, output=artifacts/renderer
- Electron bundle: 15 files, 369.9 KiB, output=artifacts/electron
