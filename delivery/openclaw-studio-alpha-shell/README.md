...
- **phase35/36 formal-release deepening**：
  ...
  - phase60 slice46 继续把 rollback settlement / apply-coupling contract向 failure-path smoke 链路推进：host blocked reason 与 connector precondition调整到“rollback settlement/apply coupling disabled”，shell boundary与 future slots新增 rollback settlement slot/handler，说明 rollback preview contracts 已被 failure-path smoke 检查，但仍旧禁止真实 host mutation
