...
- inspector 与 windowing 现在补齐 route-aware drilldowns、recent command history、Local Orchestration Board、Final Verdict Console context、Acceptance Closeout Timeline anchor、以及 Review State Continuity / Observability Closeout
